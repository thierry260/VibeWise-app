import{_ as Oe,C as Ie,r as ee,S as De,d as Se,F as Ne,g as xe,e as B,u as ie,f as ve,h as Ce,i as ae,p as Pe,j as Le,k as F,l as E,m as q,q as z,n as S,w as L,o as W,t as ce,v as Be,x as X,y as K}from"./C36XmJx2.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class R{constructor(t,n){this.bucket=t,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const t=encodeURIComponent;return"/b/"+t(this.bucket)+"/o/"+t(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(t,n){let s;try{s=R.makeFromUrl(t,n)}catch{return new R(t,"")}if(s.path==="")return s;throw Ke(t)}static makeFromUrl(t,n){let s=null;const r="([A-Za-z0-9.\\-_]+)";function o(m){m.path.charAt(m.path.length-1)==="/"&&(m.path_=m.path_.slice(0,-1))}const i="(/(.*))?$",a=new RegExp("^gs://"+r+i,"i"),c={bucket:1,path:3};function u(m){m.path_=decodeURIComponent(m.path)}const d="v[A-Za-z0-9_]+",p=n.replace(/[.]/g,"\\."),_="(/([^?#]*).*)?$",y=new RegExp(`^https?://${p}/${d}/b/${r}/o${_}`,"i"),w={bucket:1,path:3},k=n===ue?"(?:storage.googleapis.com|storage.cloud.google.com)":n,g="([^?#]*)",D=new RegExp(`^https?://${k}/${r}/${g}`,"i"),b=[{regex:a,indices:c,postModify:o},{regex:y,indices:w,postModify:u},{regex:D,indices:{bucket:1,path:2},postModify:u}];for(let m=0;m<b.length;m++){const v=b[m],M=v.regex.exec(t);if(M){const Ue=M[v.indices.bucket];let H=M[v.indices.path];H||(H=""),s=new R(Ue,H),v.postModify(s);break}}if(s==null)throw Xe(t);return s}}class et{constructor(t){this.promise_=Promise.reject(t)}getPromise(){return this.promise_}cancel(t=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tt(e,t,n){let s=1,r=null,o=null,i=!1,a=0;function c(){return a===2}let u=!1;function d(...g){u||(u=!0,t.apply(null,g))}function p(g){r=setTimeout(()=>{r=null,e(y,c())},g)}function _(){o&&clearTimeout(o)}function y(g,...D){if(u){_();return}if(g){_(),d.call(null,g,...D);return}if(c()||i){_(),d.call(null,g,...D);return}s<64&&(s*=2);let b;a===1?(a=2,b=0):b=(s+Math.random())*1e3,p(b)}let w=!1;function k(g){w||(w=!0,_(),!u&&(r!==null?(g||(a=2),clearTimeout(r),p(0)):g||(a=1)))}return p(0),o=setTimeout(()=>{i=!0,k(!0)},n),k}function nt(e){e(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function st(e){return e!==void 0}function rt(e){return typeof e=="object"&&!Array.isArray(e)}function Y(e){return typeof e=="string"||e instanceof String}function te(e){return Z()&&e instanceof Blob}function Z(){return typeof Blob<"u"}function ne(e,t,n,s){if(s<t)throw V(`Invalid value for '${e}'. Expected ${t} or greater.`);if(s>n)throw V(`Invalid value for '${e}'. Expected ${n} or less.`)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class it{constructor(t,n,s,r,o,i,a,c,u,d,p,_=!0,y=!1){this.url_=t,this.method_=n,this.headers_=s,this.body_=r,this.successCodes_=o,this.additionalRetryCodes_=i,this.callback_=a,this.errorCallback_=c,this.timeout_=u,this.progressCallback_=d,this.connectionFactory_=p,this.retry=_,this.isUsingEmulator=y,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((w,k)=>{this.resolve_=w,this.reject_=k,this.start_()})}start_(){const t=(s,r)=>{if(r){s(!1,new C(!1,null,!0));return}const o=this.connectionFactory_();this.pendingConnection_=o;const i=a=>{const c=a.loaded,u=a.lengthComputable?a.total:-1;this.progressCallback_!==null&&this.progressCallback_(c,u)};this.progressCallback_!==null&&o.addUploadProgressListener(i),o.send(this.url_,this.method_,this.isUsingEmulator,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&o.removeUploadProgressListener(i),this.pendingConnection_=null;const a=o.getErrorCode()===O.NO_ERROR,c=o.getStatus();if(!a||ot(c,this.additionalRetryCodes_)&&this.retry){const d=o.getErrorCode()===O.ABORT;s(!1,new C(!1,null,d));return}const u=this.successCodes_.indexOf(c)!==-1;s(!0,new C(u,o))})},n=(s,r)=>{const o=this.resolve_,i=this.reject_,a=r.connection;if(r.wasSuccessCode)try{const c=this.callback_(a,a.getResponse());st(c)?o(c):o()}catch(c){i(c)}else if(a!==null){const c=G();c.serverResponse=a.getErrorText(),this.errorCallback_?i(this.errorCallback_(a,c)):i(c)}else if(r.canceled){const c=this.appDelete_?he():We();i(c)}else{const c=ze();i(c)}};this.canceled_?n(!1,new C(!1,null,!0)):this.backoffId_=tt(t,n,this.timeout_)}getPromise(){return this.promise_}cancel(t){this.canceled_=!0,this.appDelete_=t||!1,this.backoffId_!==null&&nt(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}}class C{constructor(t,n,s){this.wasSuccessCode=t,this.connection=n,this.canceled=!!s}}function at(e,t){t!==null&&t.length>0&&(e.Authorization="Firebase "+t)}function ct(e,t){e["X-Firebase-Storage-Version"]="webjs/"+(t??"AppManager")}function ut(e,t){t&&(e["X-Firebase-GMPID"]=t)}function lt(e,t){t!==null&&(e["X-Firebase-AppCheck"]=t)}function ht(e,t,n,s,r,o,i=!0,a=!1){const c=de(e.urlParams),u=e.url+c,d=Object.assign({},e.headers);return ut(d,t),at(d,n),ct(d,o),lt(d,s),new it(u,e.method,d,e.body,e.successCodes,e.additionalRetryCodes,e.handler,e.errorHandler,e.timeout,e.progressCallback,r,i,a)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const T={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class j{constructor(t,n){this.data=t,this.contentType=n||null}}function gt(e,t){switch(e){case T.RAW:return new j(fe(t));case T.BASE64:case T.BASE64URL:return new j(pe(e,t));case T.DATA_URL:return new j(wt(t),Rt(t))}throw G()}function fe(e){const t=[];for(let n=0;n<e.length;n++){let s=e.charCodeAt(n);if(s<=127)t.push(s);else if(s<=2047)t.push(192|s>>6,128|s&63);else if((s&64512)===55296)if(!(n<e.length-1&&(e.charCodeAt(n+1)&64512)===56320))t.push(239,191,189);else{const o=s,i=e.charCodeAt(++n);s=65536|(o&1023)<<10|i&1023,t.push(240|s>>18,128|s>>12&63,128|s>>6&63,128|s&63)}else(s&64512)===56320?t.push(239,191,189):t.push(224|s>>12,128|s>>6&63,128|s&63)}return new Uint8Array(t)}function mt(e){let t;try{t=decodeURIComponent(e)}catch{throw x(T.DATA_URL,"Malformed data URL.")}return fe(t)}function pe(e,t){switch(e){case T.BASE64:{const r=t.indexOf("-")!==-1,o=t.indexOf("_")!==-1;if(r||o)throw x(e,"Invalid character '"+(r?"-":"_")+"' found: is it base64url encoded?");break}case T.BASE64URL:{const r=t.indexOf("+")!==-1,o=t.indexOf("/")!==-1;if(r||o)throw x(e,"Invalid character '"+(r?"+":"/")+"' found: is it base64 encoded?");t=t.replace(/-/g,"+").replace(/_/g,"/");break}}let n;try{n=_t(t)}catch(r){throw r.message.includes("polyfill")?r:x(e,"Invalid character found")}const s=new Uint8Array(n.length);for(let r=0;r<n.length;r++)s[r]=n.charCodeAt(r);return s}class _e{constructor(t){this.base64=!1,this.contentType=null;const n=t.match(/^data:([^,]+)?,/);if(n===null)throw x(T.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const s=n[1]||null;s!=null&&(this.base64=yt(s,";base64"),this.contentType=this.base64?s.substring(0,s.length-7):s),this.rest=t.substring(t.indexOf(",")+1)}}function wt(e){const t=new _e(e);return t.base64?pe(T.BASE64,t.rest):mt(t.rest)}function Rt(e){return new _e(e).contentType}function yt(e,t){return e.length>=t.length?e.substring(e.length-t.length)===t:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Et(e,t){return t}class f{constructor(t,n,s,r){this.server=t,this.local=n||t,this.writable=!!s,this.xform=r||Et}}let P=null;function kt(e){return!Y(e)||e.length<2?e:me(e)}function we(){if(P)return P;const e=[];e.push(new f("bucket")),e.push(new f("generation")),e.push(new f("metageneration")),e.push(new f("name","fullPath",!0));function t(o,i){return kt(i)}const n=new f("name");n.xform=t,e.push(n);function s(o,i){return i!==void 0?Number(i):i}const r=new f("size");return r.xform=s,e.push(r),e.push(new f("timeCreated")),e.push(new f("updated")),e.push(new f("md5Hash",null,!0)),e.push(new f("cacheControl",null,!0)),e.push(new f("contentDisposition",null,!0)),e.push(new f("contentEncoding",null,!0)),e.push(new f("contentLanguage",null,!0)),e.push(new f("contentType",null,!0)),e.push(new f("metadata","customMetadata",!0)),P=e,P}function At(e,t){function n(){const s=e.bucket,r=e.fullPath,o=new R(s,r);return t._makeStorageReference(o)}Object.defineProperty(e,"ref",{get:n})}function Ut(e,t,n){const s={};s.type="file";const r=n.length;for(let o=0;o<r;o++){const i=n[o];s[i.local]=i.xform(s,t[i.server])}return At(s,e),s}function Re(e,t,n){const s=ge(t);return s===null?null:Ut(e,s,n)}function Ot(e,t,n,s){const r=ge(t);if(r===null||!Y(r.downloadTokens))return null;const o=r.downloadTokens;if(o.length===0)return null;const i=encodeURIComponent;return o.split(",").map(u=>{const d=e.bucket,p=e.fullPath,_="/b/"+i(d)+"/o/"+i(p),y=Q(_,n,s),w=de({alt:"media",token:u});return y+w})[0]}function It(e,t){const n={},s=t.length;for(let r=0;r<s;r++){const o=t[r];o.writable&&(n[o.server]=e[o.local])}return JSON.stringify(n)}class ye{constructor(t,n,s,r){this.url=t,this.method=n,this.handler=s,this.timeout=r,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function be(e){if(!e)throw G()}function Dt(e,t){function n(s,r){const o=Re(e,r,t);return be(o!==null),o}return n}function St(e,t){function n(s,r){const o=Re(e,r,t);return be(o!==null),Ot(o,r,e.host,e._protocol)}return n}function Te(e){function t(n,s){let r;return n.getStatus()===401?n.getErrorText().includes("Firebase App Check token is invalid")?r=Ve():r=je():n.getStatus()===402?r=$e(e.bucket):n.getStatus()===403?r=qe(e.path):r=s,r.status=n.getStatus(),r.serverResponse=s.serverResponse,r}return t}function Nt(e){const t=Te(e);function n(s,r){let o=t(s,r);return s.getStatus()===404&&(o=He(e.path)),o.serverResponse=r.serverResponse,o}return n}function xt(e,t,n){const s=t.fullServerUrl(),r=Q(s,e.host,e._protocol),o="GET",i=e.maxOperationRetryTime,a=new ye(r,o,St(e,n),i);return a.errorHandler=Nt(t),a}function vt(e,t){return e&&e.contentType||t&&t.type()||"application/octet-stream"}function Ct(e,t,n){const s=Object.assign({},n);return s.fullPath=e.path,s.size=t.size(),s.contentType||(s.contentType=vt(null,t)),s}function Pt(e,t,n,s,r){const o=t.bucketOnlyServerUrl(),i={"X-Goog-Upload-Protocol":"multipart"};function a(){let b="";for(let m=0;m<2;m++)b=b+Math.random().toString().slice(2);return b}const c=a();i["Content-Type"]="multipart/related; boundary="+c;const u=Ct(t,s,r),d=It(u,n),p="--"+c+`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class I{constructor(t,n){this._service=t,n instanceof R?this._location=n:this._location=R.makeFromUrl(n,t.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(t,n){return new I(t,n)}get root(){const t=new R(this._location.bucket,"");return this._newRef(this._service,t)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return me(this._location.path)}get storage(){return this._service}get parent(){const t=bt(this._location.path);if(t===null)return null;const n=new R(this._location.bucket,t);return new I(this._service,n)}_throwIfRoot(t){if(this._location.path==="")throw Je(t)}}function Ft(e,t,n){e._throwIfRoot("uploadBytes");const s=Pt(e.storage,e._location,we(),new A(t,!0),n);return e.storage.makeRequestWithTokens(s,Ee).then(r=>({metadata:r,ref:e}))}function Mt(e){e._throwIfRoot("getDownloadURL");const t=xt(e.storage,e._location,we());return e.storage.makeRequestWithTokens(t,Ee).then(n=>{if(n===null)throw Ze();return n})}function Ht(e,t){const n=Tt(e._location.path,t),s=new R(e._location.bucket,n);return new I(e.storage,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
