<script lang="ts">
  ...
  const predefinedTags = [
    'Work', 'Family', 'Friends', 'Health', 'Relationship', 
    'Personal Growth', 'Finances', 'Creativity', 'Spirituality'
  ];
...
<div class="reflect-container">
  ...
  <div class="form-section">
    ...
    <div class="mood-selector">
      <div class="mood-tabs">
        <button 
          class:active={activeGroup === 'high'} 
          on:click={() => activeGroup = 'high'}
        >
          High Vibes
        </button>
        <button 
          class:active={activeGroup === 'neutral'} 
          on:click={() => activeGroup = 'neutral'}
        >
          Neutral
        </button>
        <button 
          class:active={activeGroup === 'low'} 
          on:click={() => activeGroup = 'low'}
        >
          Low Vibes
        </button>
      </div>
    ...
    <div class="voice-recorder">
      ...
      {:else if audioUrl}
        <div class="audio-player">
          ...
          <button class="delete-button" on:click={() => { audioUrl = null; audioBlob = null; voiceInsight = null; }}>
            Delete Recording
          </button>
          {#if !voiceInsight && !isAnalyzingVoice}
            <button class="analyze-button" on:click={analyzeVoice}>
              Analyze Voice Tone
            </button>
...
<style>
  ...
  .mood-chip.selected, .tag-chip.selected {
