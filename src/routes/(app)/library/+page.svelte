    ...
    {:else if activeTab === 'Spiral Dynamics'}
      <div class="spiral-content">
        <div class="spiral-intro">
          ...
          <p>Spiral Dynamics is a model of human development that describes how worldviews, value systems, and ways of thinking evolve in individuals and societies.</p>
          <p>The model is represented as a spiral with different colors representing different stages or "memes" of development.</p>
        </div>
...
<style>
  ...
  .practices-list, .resources-list {
    display: flex;
    flex-direction: column;
    gap: 1rem;
  }
  
  .practice-card, .resource-card {
    display: flex;
    align-items: center;
    gap: 1rem;
    padding: 1rem;
  ...
  .practice-card:hover, .resource-card:hover {
    transform: translateY(-2px);
  }
  
  .practice-icon, .resource-icon {
    font-size: 1.5rem;
    width: 3rem;
    height: 3rem;
    display: flex;
  ...
  .practice-details, .resource-details {
    flex: 1;
  }
  
  .practice-details h3, .resource-details h3 {
    margin: 0 0 0.25rem 0;
    font-size: 1.1rem;
  }
  
  .practice-details p, .resource-details p {
  ...
  .start-button:hover, .view-button:hover {
    opacity: 0.9;
  }
  ...
  .level-card.beige { border-color: #E8DDCB; }
  .level-card.purple { border-color: #9B59B6; }
  .level-card.red { border-color: #E74C3C; }
  .level-card.blue { border-color: #3498DB; }
  .level-card.orange { border-color: #E67E22; }
  .level-card.green { border-color: #2ECC71; }
  .level-card.yellow { border-color: #F1C40F; }
  .level-card.turquoise { border-color: #1ABC9C; }
